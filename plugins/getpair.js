...
malvin({
    ...
    try {
        ...
        if (!q || !isValidPhoneNumber(q)) {
            return await reply("*❌ Invalid phone number format! Please use: .pair +263714757XXX*");
        }
        ...
        const response = await fetchJson(`https://malvin-pair-code-xzcb.onrender.com/code?phone=${q}`);
        ...
        const successMessage = `✅ *MALVIN-XD PAIR COMPLETED*\n\nYour pairing code is: ${pairingCode}`;
